# 1 "/tmp/tmpbkiykqji"
#include <Arduino.h>
# 1 "/home/rene/Documentos/T-Deck/examples/T/T.ino"
#include <Arduino.h>
#include "utilities.h"
#include <Wire.h>
#include <TFT_eSPI.h>
...
void setup();
void loop();
#line 78 "/home/rene/Documentos/T-Deck/examples/T/T.ino"
static void loadSettings(){
    char color[7];
...
void wifi_auto_connect(void * param){
    ...
    String s = "Searching for wifi connections...";

    tft.drawCentreString(s, 120, 0, 1);
