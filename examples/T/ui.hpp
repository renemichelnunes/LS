...
/*contacts form*/
lv_obj_t * contacts_form;
lv_obj_t * btn_frm_contatcs_close;
lv_obj_t * lbl_btn_frm_contacts_close;
lv_obj_t * list;
lv_obj_t * btn_frm_contatcs_add;
lv_obj_t * lbl_btn_frm_contacts_add;
lv_obj_t * btn_frm_contatcs_title;
lv_obj_t * lbl_btn_frm_contacts_title;
/*add contact form*/
