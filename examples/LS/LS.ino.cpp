...
void setup();
void loop();
#line 152 "/home/rene/Documents/T-Deck/examples/LS/LS.ino"
static void loadSettings(){
    char color[7];
...
bool DXMode()
{
# 1894 "/home/rene/Documents/T-Deck/examples/LS/LS.ino"
    if(xSemaphoreTake(xSemaphore, portMAX_DELAY) == pdTRUE){
        radio.sleep(false);
        radio.reset();
        radio.begin();
...
void ping(lv_event_t * e){
# 2074 "/home/rene/Documents/T-Deck/examples/LS/LS.ino"
}
...
# 2607 "/home/rene/Documents/T-Deck/examples/LS/LS.ino"
void setDate(int yr, int month, int mday, int hr, int minute, int sec, int isDst){
...
# 3350 "/home/rene/Documents/T-Deck/examples/LS/LS.ino"
void show_especial(lv_event_t * e){
    lv_event_code_t code = lv_event_get_code(e);
...
void setup(){
    ...
    ui();
# 4808 "/home/rene/Documents/T-Deck/examples/LS/LS.ino"
    loadSettings();
...
void loop(){
    ...
    lv_task_handler();
    pthread_mutex_unlock(&lvgl_mutex);
# 4852 "/home/rene/Documents/T-Deck/examples/LS/LS.ino"
    delay(5);
}