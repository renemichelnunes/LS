# 1 "/tmp/tmpsikdd_i5"
#include <Arduino.h>
# 1 "/home/rene/Documents/LS/examples/LS/LS.ino"
#include <Arduino.h>
#include "utilities.h"
#include <Wire.h>
#include <TFT_eSPI.h>
...
void setup();
void loop();
#line 154 "/home/rene/Documents/LS/examples/LS/LS.ino"
static void loadSettings(){
    char color[7];
...
bool DXMode()
{
# 1832 "/home/rene/Documents/LS/examples/LS/LS.ino"
    if(xSemaphoreTake(xSemaphore, portMAX_DELAY) == pdTRUE){
        radio.sleep(false);
        radio.reset();
        radio.begin();
...
void ping(lv_event_t * e){
# 2012 "/home/rene/Documents/LS/examples/LS/LS.ino"
}
...
# 2634 "/home/rene/Documents/LS/examples/LS/LS.ino"
void setDate(int yr, int month, int mday, int hr, int minute, int sec, int isDst){
...
# 3377 "/home/rene/Documents/LS/examples/LS/LS.ino"
void show_especial(lv_event_t * e){
    lv_event_code_t code = lv_event_get_code(e);
...
void setup(){
    ...
    ui();
# 4860 "/home/rene/Documents/LS/examples/LS/LS.ino"
    loadSettings();
...
void loop(){
    ...
    lv_task_handler();
    pthread_mutex_unlock(&lvgl_mutex);
# 4904 "/home/rene/Documents/LS/examples/LS/LS.ino"
    delay(5);
}