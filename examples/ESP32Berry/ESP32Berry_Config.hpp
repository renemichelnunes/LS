...
// Set your Timezone
#define TIME_ZONE "<-03>3" // https://github.com/esp8266/Arduino/blob/master/cores/esp8266/TZ.h
...
#define OPENAI_API_KEY "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"
